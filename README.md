...
[![GitHub Stars](https://img.shields.io/github/stars/chris-cpz/strategy-m?style=for-the-badge&logo=github)](https://github.com/chris-cpz/strategy-m)
...
```bash
# Clone repository
git clone https://github.com/chris-cpz/strategy-m.git
cd strategy-m
...
```python
from strategy import mStrategy
...
- **Documentation**: [Wiki](https://github.com/chris-cpz/strategy-m/wiki)
- **Issues**: [GitHub Issues](https://github.com/chris-cpz/strategy-m/issues)
- **Discussions**: [GitHub Discussions](https://github.com/chris-cpz/strategy-m/discussions)
